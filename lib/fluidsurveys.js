 ...
 * @return {Object}        {@link FluidSurveys}
 */
FluidSurveys.prototype.get = function ( type, id,details,args, cb ) {
	var deferreds = [],
		queryString="",
	    headers, url;
	...
	if ( type === "surveys" ) {
		...
		(details !== null )?deferreds.push( this.request( "get", uri( this.host, type, id, details )+queryString, null, headers ) ):
							deferreds.push( this.request( "get", uri( this.host, type, id ), null, headers )+queryString );
	}
